      ...
      <div className="container px-4 md:px-6 z-10">
        <div className="grid gap-6">
          <h1 className="font-headline tracking-tighter text-4xl font-bold sm:text-5xl md:text-6xl lg:text-7xl">
            Building Digital Excellence for <span className="text-primary">Localpad</span>
          </h1>
          <p className="max-w-[700px] mx-auto text-muted-foreground md:text-xl">
            We build beautiful, fast, and secure software solutions to help your business grow. From concept to launch, we're your dedicated development partner.
          </p>
